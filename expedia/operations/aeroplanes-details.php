...
class aeroplanes
{
    ...
    public function __construct($cat, $pic, $serviceco, $ratings, $from, $to, $discount, $actualpr, $price, $locationfrom, $locationto)
    {
    ...
    {
        global $connection;
        $insertQuery = "INSERT INTO `aeroplanes_details`(`category`, `image`, `servicecompany`, `ratings`, `availfrom`, `availto`, `discount`, `actualprice`, `dprice`, `locationfrom`, `locationto`) 
        VALUES ('$this->aeroplaneCatogry','$this->aeroplanepicture','$this->aeroservicecompany','$this->aeroexperience','$this->aeroavlabledatefrom','$this->aeroavlabledateto','$this->aerodiscount','$this->aeroactualprice','$this->aeroprice','$this->locationfrom','$this->locationto')";
...
$dataInsert = new aeroplanes($aeroplaneCatogry, $aeroplanepicture, $aeroservicecompany, $aeroexperience, $aeroavlabledatefrom, $aeroavlabledateto, $aerodiscount, $aeroactualprice, $aeroprice, $locationfrom, $locationto);
