...
$sqlQuery = "INSERT INTO `hotels-details`(`session_id`, `place`, `category`, `hotel_name`, `hotels_rating`, `availabledate_from`, `availabledate_to`, `hotel_rate`, `hotel_price`, `hotels_actual_price`, `hotel_img`) VALUES ('$sessionId','$hotelPlace','$category','$hotelName','$hotelRValue','$hotelDateFrom','$hotelDateTo','$hotelRate','$hotelRupees','$hotelActualRupees','0')";
