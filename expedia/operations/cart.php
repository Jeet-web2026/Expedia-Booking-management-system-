                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="d-flex aign-items-center mb-2">
                                ...
                                <div>
                                    <h6 class="badge bg-secondary no-radius">' . htmlspecialchars(trim($_SESSION['trip_adults'])) . '</h6><br>
                                    <h6 class="badge bg-secondary no-radius">' . htmlspecialchars(trim($_SESSION['trip_children'])) . '</h6>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mt-4">
                                ...
                                <a href="" class="btn border-0 shadow web-btn">Cancel booking</a>
                            </div>
                        </div>
                    </div>
                </div>
