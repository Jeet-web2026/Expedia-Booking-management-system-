            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <button type="button" class="btn shadow-none border-0 text-light" data-bs-toggle="modal" data-bs-target="#region-modal">
                        <span class="region-text">Region</span><i class="fa-solid fa-earth-asia fa-spin ms-2"></i>
                    </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body d-flex justify-content-center align-items-center">
                                    <input type="password" class="form-control w-100 shadow-none" placeholder="Your region name">
                                    <button type="submit" id="region-input" class="btn shadow-none border-0" style="background-color: #ffc107; color: #011634f0;">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
