...
<script>
    $(document).ready(function() {
        ...
        $('#hotel-details-add #hotels-detail-upload').on('submit', function(event) {
            event.preventDefault();
            if ($('#hotel-picture').val() == '' || $('#hotel-name').val() == '' || $('#ratings').val() == '' || $('#avail-date-from').val() == '' || $('#avail-date-to').val() == '' || $('#discountrate').val() == '' || $('#value').val() == '' || $('#hotelAvailableCity').val() == '') {
        ...
        $('#aeroplanes-details-add #aeroplanes-detail-upload').on('submit', function(event) {
            event.preventDefault();
            if ($('#aeroplanes-picture').val() == '' || $('#aeroplanes-name').val() == '' || $('#experience').val() == '' || $('#aeroavail-date-from').val() == '' || $('#aeroavail-date-to').val() == '' || $('#aerodiscountrate').val() == '' || $('#aerovalue').val() == '' || $('#aeroactualValue').val() == '' || $('#location_from').val() == '' || $('#location_to').val() == '') {
        ...
        $('#taxis-details-add #taxi-detail-upload').on('submit', function(event) {
            event.preventDefault();
            if ($('#taxi-picture').val() == '' || $('#service-company-name').val() == '' || $('#taxiratings').val() == '' || $('#taxiavail-datefrom').val() == '' || $('#taxiavail-date-to').val() == '' || $('#taxidiscountrate').val() == '' || $('#taxiactualValue').val() == '' || $('#taxiValue').val() == '' || $('#taxilocation_from').val() == '' || $('#taxilocation_to').val() == '') {
