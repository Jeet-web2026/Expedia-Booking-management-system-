...
<script>
    $(document).ready(function() {
        ...
        $('#hotel-settings #hotels-detail-upload').on('submit', function(event) {
            event.preventDefault();
            if ($('#hotel-picture').val() == '' || $('#hotel-name').val() == '' || $('#ratings').val() == '' || $('#avail-date-from').val() == '' || $('#avail-date-to').val() == '' || $('#discountrate').val() == '' || $('#value').val() == '') {
        ...
        $("#hotel-settings #hotels-detail-upload #discountrate, #hotel-settings #hotels-detail-upload #actualValue").on("input", function() {
            let actualValue = parseFloat($("#hotel-settings #hotels-detail-upload #actualValue").val()) || 0;
            let disCount = parseFloat($("#hotel-settings #hotels-detail-upload #discountrate").val()) || 0;
            let discountValue = Math.round((actualValue * disCount) / 100);
            let theValue = (actualValue - discountValue);
            if (!isNaN(theValue)) {
                $("#hotel-settings #hotels-detail-upload #value").val(theValue);
            } else {
                $("#hotel-settings #hotels-detail-upload #value").val("");
            }
        });
        ...
        $('#admin-view .tab-content .tab-pane #nav-settings-items #hotel-settings').on('click', function() {
            $('#admin-view #add-settings #hotel-details-add').fadeToggle();
            $('#admin-view #add-settings #hotel-details-add').siblings().hide();
        });

        $('#admin-view .tab-content .tab-pane #nav-settings-items #aeroplanes-settings').on('click', function() {
            $('#admin-view #add-settings #aeroplanes-details-add').fadeToggle();
        ...
        $('#admin-view .tab-content .tab-pane #nav-settings-items #taxis-settings').on('click', function() {
            $('#admin-view #add-settings #taxis-details-add').fadeToggle();
