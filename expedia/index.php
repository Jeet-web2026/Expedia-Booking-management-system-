                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 pe-3">
                            <div class="card border-0 bg-transparent">
                                <div class="card-body d-flex justify-content-between px-0 chooseOptions">
                                    ...
                                    <select class="form-select w-50 border-0 shadow-none" aria-label="Default select example" name="querySearchtour-type">
                        ...
                        <div class="col-md-6 pe-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-0 shadow-none py-2" id="from" name="querysearchFrom" placeholder="Your home address">
                        ...
                        <div class="col-md-6 ps-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control border-0 shadow-none py-2" id="to" name="querysearchTo" placeholder="e.g. Russia, Japan">
                            </div>
                        </div>
                        <div class="col-md-6 pe-3">
                            <div class="row">
                                <div class="col-md-6 pe-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control border-0 shadow-none py-2" id="departs" name="querysearchDeparts" placeholder="Your home address">
                                    </div>
                                </div>
                                <div class="col-md-6 ps-3">
                                    <div class="mb-3">
                                        <label for="returning" class="form-label text-light">Returning</label>
                                        <input type="date" class="form-control border-0 shadow-none py-2" id="returning" name="querysearchReturning" placeholder="Your home address">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 pe-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select shadow-none border-0 py-2" aria-label="Default select example" name="querysearchAdultscount">
                                ...
                                <div class="col-md-6 ps-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select shadow-none border-0 py-2" aria-label="Default select example" name="querysearchChildrencount">
                                            <option selected>0</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
            ...
            foreach ($viewContent as $view) {
                ...
                ' . htmlspecialchars($formattedDateFrom) . ' - ' . htmlspecialchars($_SESSION['HotelformattedDateTo']) . '
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="/expedia/operations/booking-confirmation.php?id=' . htmlspecialchars($view["id"]) . '&db=hotels-details" class="btn shadow-none border-0 web-font fs-5 fw-bold text-uppercase hotel-book">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
