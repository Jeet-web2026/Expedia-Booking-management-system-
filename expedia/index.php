            ...
            foreach ($viewContent as $view) {
                ...
                ' . htmlspecialchars($formattedDateFrom) . ' - ' . htmlspecialchars($_SESSION['HotelformattedDateTo']) . '
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="expedia/operations/cart.php?id=' . htmlspecialchars($view["id"]) . '" class="btn shadow-none border-0 web-font fs-5 fw-bold text-uppercase hotel-book">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
