            ...
            if ($fetchResultQueryforResult && mysqli_num_rows($fetchResultQueryforResult) > 0) {
                foreach ($fetchResultQueryforResult as $fetchResultQueryforView) {
                    ...
                    echo '
                                     ...
                                     <a href="expedia/operations/cart.php?id='. htmlspecialchars(trim($fetchResultQueryforView['id'])) .'" type="submit" class="btn web-btn border-0 px-3 font-500">Order now</a>
                                </div>
                                </div>
                            </div>
                        </div>
