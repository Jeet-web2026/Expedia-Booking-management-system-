            ...
            if ($fetchResultQueryforResult && mysqli_num_rows($fetchResultQueryforResult) > 0) {
                foreach ($fetchResultQueryforResult as $fetchResultQueryforView) {
                    ...
                    echo '
                                     ...
                                     <a href="/expedia/operations/booking-confirmation.php?id=' . htmlspecialchars(trim($fetchResultQueryforView['id'])) . '&db=' . htmlspecialchars(trim($tableSource)) . '" type="submit" class="btn web-btn click-to-fetch border-0 px-3 font-500">Order now</a>
                                </div>
                                </div>
                            </div>
                        </div>
