                        ...
                        <section id="hotel-details-add">
                            <div class="container-fluid p-5">
                                <form class="bg-light p-5" id="hotels-detail-upload" method="POST" action="../operations/hotels-details.php">
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" id="hotel-Id" name="hotelId">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pe-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6 pe-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control shadow-none no-radius" id="ratings" name="ratingsValue">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                        ...
                        <section id="aeroplanes-details-add">
                            <div class="container-fluid px-5 py-4">
                                <form class="bg-light p-5" id="aeroplanes-detail-upload" method="POST" action="../operations/aeroplanes-details.php">
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" id="aeroplanes-Id" name="aeroplanesId">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pe-3">
                                            <div class="mb-3">
                        ...
                        <section id="taxis-details-add">
                            <div class="container-fluid px-5 py-4">
                                <form class="bg-light p-5" id="taxi-detail-upload" method="POST" action="../operations/taxi-details.php">
                                    ...
                                    <div>
                                        <input type="hidden" class="form-control" id="taxi-Id" name="taxiId">
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pe-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6 pe-3">
                                            <div class="mb-3">
                                                <label for="taxiratings" class="form-label">Ratings</label>
                                                <input type="text" class="form-control shadow-none no-radius" id="taxiratings" name="taxiratings">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
