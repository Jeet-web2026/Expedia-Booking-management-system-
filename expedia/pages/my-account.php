                        ...
                        <div class="col-md-6 border-end pe-lg-5">
                            <div class="d-flex justify-content-between">
                                <div class="mb-3 w-100 me-lg-3">
                                    <label for="frstname" class="form-label text-light">First name</label>
                                    <input type="text" class="form-control shadow-none border-0 text-capitalize" id="frstname" name="frstname">
                                </div>
                                <div class="mb-3 w-100">
                                    <label for="lstname" class="form-label text-light">Last name</label>
                                    <input type="text" class="form-control shadow-none border-0 text-capitalize" id="lstname" name="lstname">
                                </div>
                            </div>
                            <div class="mb-3 w-100">
                                <label for="mobileno" class="form-label text-light">Mobile number</label>
                                <input type="number" class="form-control shadow-none border-0" id="mobileno" name="mobileno">
                            </div>
                        </div>
                ...
                <form action="../operations/signup-verify.php" id="signup-form-data" method="POST" class="p-5 rounded" style="background-color: #011634f0;">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="signup-address" style="height: 100px" name="signup-address"></textarea>
                        </div>
                    </div>
